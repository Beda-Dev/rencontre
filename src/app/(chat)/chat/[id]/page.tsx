        ...
        {profile && (
          <>
            ...
            <button
              ...
              title="Appel vidéo"
              className="p-1.5 text-white/50 hover:text-amber-400"
            >
          ...
          <div className="mt-2 flex items-center justify-between">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="rounded-full bg-amber-400 px-3 py-1 text-xs font-medium text-black"
              >
                Envoyer
              </button>
            </div>
        ...
        {audioRecorder.status === "recording" ? (
          <div className="flex flex-1 items-center gap-2 rounded-full bg-white/5 px-3 py-2">
            ...
            <button
              ...
              className="rounded-full bg-amber-400 p-1.5 text-black"
            >
          ...
          <>
            <button
              ...
              className="shrink-0 rounded-full p-2 text-white/60 hover:text-amber-400"
            ...
            {draft.trim() ? (
              <button
                ...
                className="shrink-0 rounded-full bg-amber-400 p-2.5 text-black disabled:opacity-40"
              >
