...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center px-6 py-10">
      <PinFlameLogo className="h-14 w-14 text-violet-400" />
        ...
        <>
          <form onSubmit={handleSubmit} className="mt-8 w-full max-w-sm space-y-3">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full rounded-lg bg-violet-400 py-2.5 text-sm font-semibold text-black transition hover:bg-violet-300 disabled:opacity-60"
            >
