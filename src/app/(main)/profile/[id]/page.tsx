    ...
    <div className="mx-auto max-w-2xl">
      ...
      <div className="flex gap-2 px-4 py-3">
        ...
        <Link
          ...
          className="flex flex-1 items-center justify-center gap-2 rounded-lg bg-violet-400 py-2.5 text-sm font-medium text-black hover:bg-violet-300"
        >
      ...
      {profile.isFavorite && (
        <div className="px-4 pb-4">
          ...
          <textarea
            ...
            className="w-full resize-none rounded-lg border border-white/10 bg-white/5 px-3 py-2 text-sm outline-none focus:border-violet-400"
          />
        </div>
      )}
